package io.cursokafka.icompras.logistica.subscriber;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.cursokafka.icompras.logistica.service.EnvioPedidoService;
import io.cursokafka.icompras.logistica.subscriber.representation.AtualizacaoFaturamentoRepresentation;
...
public class FaturamentoSubscriber {
    ...
    public void listen(String json) {
        ...
        try {
            ...
            log.error("Erro ao preparar pedido para o envio", e);
        }
    }
}
